...
class CatalogManager:
    ...
    def flatten_catalog_paths(self, catalog_data: List[Dict[str, Any]], parent_path: str = "") -> List[str]:
        """
    ...
    def load_catalog_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"Error: {self.catalog_file} file not found. Please run fetch_catalog_data() first.")
            return {}
        except json.JSONDecodeError as e:
